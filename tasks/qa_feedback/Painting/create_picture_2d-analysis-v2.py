...
run_names = [
    ...
    # "3（Test）comp_rm_step_1230_acc_0.690"  # 注释掉的run名称

    # base
    # "2-KL-1700（Test）rel_rm_step_1502_f1_0.658_acc_0.675",  # 注释掉的run名称
    # "2-KL-1600（Test）rel_rm_step_452_f1_0.661_acc_0.682",
    # "2-KL-1200（Test）rel_rm_step_1052_f1_0.696_acc_0.690",
    # "2-KL-2500（Test）rel_rm_step_902_f1_0.677_acc_0.686",
    # "2-KL-2900（Test）rel_rm_step_602_f1_0.702_acc_0.692",  # 注释掉的run名称
    # "1-KL-400（Test）fact_rm_step_728_f1_0.647_acc_0.754",
    # "1（Test）fact_rm_step_332_f1_0.646_acc_0.761",
    # "1（Test）fact_rm_step_2_f1_0.087_acc_0.638",
    # "1（Test）fact_rm_step_68_f1_0.211_acc_0.677",
    # "1-KL-700（Test）fact_rm_step_530_f1_0.656_acc_0.769",
    # "1-KL-300（Test）fact_rm_step_926_f1_0.661_acc_0.773",
    # "3（Test）comp_rm_step_630_acc_0.665",
    # "3（Test）comp_rm_step_2130_acc_0.674",
    # "3（Test）comp_rm_step_1230_acc_0.690",

    # large
    # "2（Test）rel_rm_step_2702_f1_0.644_acc_0.670",
    # "2-KL-8800（Test）rel_rm_step_452_f1_0.661_acc_0.682",
    # "2（Test）rel_rm_step_1802_f1_0.674_acc_0.682",
    # "2（Test）rel_rm_step_1352_f1_0.689_acc_0.682",
    # "2（Test）rel_rm_step_1202_f1_0.682_acc_0.684",
    # "2（Test）rel_rm_step_902_f1_0.677_acc_0.686",
    # "1（Test）fact_rm_step_1256_f1_0.645_acc_0.759",
    # "1（Test）fact_rm_step_530_f1_0.656_acc_0.769",
    # "3（Test）comp_rm_step_3630_acc_0.679",
    # "3（Test）comp_rm_step_4530_acc_0.683",
    "3（Test）comp_rm_step_5730_acc_0.688",
    # "3（Test）comp_rm_step_3030_acc_0.689",
    # "3（Test）comp_rm_step_1230_acc_0.690",
